...
A look at the intricate intricate network of different components in today's cars, as shown in Figure \ref{fig:VheicleProcessors}, reveals that a vehicle is actually composed of a mosaic of dozens of different systems, which in turn are composed of dozens of processors that interact with each other at different levels, earning today's vehicles the nickname \textit{'Computers on Wheels'}.
...
PARLARE DEI SISTEMI EMBEDDED FACENDO RIFERIMENTO ALL'ARTICOLO https://www.sciencedirect.com/science/article/abs/pii/S2214209620300565#preview-section-introduction PER POI PARLARE DI DIGITAL TWIN E POI DI SDV 
